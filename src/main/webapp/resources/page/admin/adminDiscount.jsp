                ...
                <section class="features" id="features">
                    <div class="Make an order">
                        ...
                        <div class="form__name">
                            <h2> <fmt:message key="text.discounts.head" bundle="${locale}"/></h2>
                                    ...
                                    <tr>
                                        <form method="post" action="admin?action=discount">
                                            ...
                                            <c:if test="${!participant.banned}">
                                                <td id="btn"> <input type="submit" class="ban" name="button" id="ban"
                                                                     value="<fmt:message key="text.discounts.discount.button" bundle="${locale}"/>"></td>
